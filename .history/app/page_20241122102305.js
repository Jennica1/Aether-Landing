    ...
    <div className={styles.page}>
      ...
      <footer className={styles.footer}>
        <div className={styles.row}>
          ...
          <ul className={styles.column}>
            <li className={styles.smIcon}> <Image src='/Fb.png' alt="facebook icon" width={30} height={30} />Facebook</li>
            <li className={styles.smIcon}> <Image src='/Ig.png' alt="facebook icon" width={30} height={30} />Instagram</li>
